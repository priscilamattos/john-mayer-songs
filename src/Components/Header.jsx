      ...
      <div className="image-container">
        ...
        <div className="header-gradient">
          ...
          <p className="header-subtitle wrapper">
            ...
            himself in contemporary rock and broadening his scope to incorporate
            the blues. Most of his albums are commercially successful and have
            been accredited multi-platinum.
          </p>
        </div>
      </div>
    </header>
